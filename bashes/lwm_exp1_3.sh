python3 -u src/main_incremental.py --gpu 3 --results-path exp1_3  --eval-on-train --batch-size 128 --wandb-project exp1_3_lwm --nepoch 200 --approach lwm --dkd-control adaptive --dkd-m 2.0 --dkd-switch ada_switch_1 --dkd-shape one --distill-percent 1 --ikr-control none
python3 -u src/main_incremental.py --gpu 3 --results-path exp1_3  --eval-on-train --batch-size 128 --wandb-project exp1_3_lwm --nepoch 200 --approach lwm --dkd-control adaptive --dkd-m 2.0 --dkd-switch ada_switch_2 --dkd-shape one --distill-percent 0.2 --ikr-control none


### 돌려야 함
python3 -u src/main_incremental.py --gpu 0 --results-path exp1_3  --eval-on-train --batch-size 128 --wandb-project exp1_3_lwm --nepoch 200 --approach lwm --dkd-control adaptive --dkd-m 2.0 --dkd-switch ada_switch_3 --dkd-shape one --distill-percent 0.2 --ikr-control none
python3 -u src/main_incremental.py --gpu 0 --results-path exp1_3  --eval-on-train --batch-size 128 --wandb-project exp1_3_lwm --nepoch 200 --approach lwm --dkd-control adaptive --dkd-m 2.0 --dkd-switch ada_switch_4 --dkd-shape one --distill-percent 0.2 --ikr-control none
python3 -u src/main_incremental.py --gpu 0 --results-path exp1_3  --eval-on-train --batch-size 128 --wandb-project exp1_3_lwm --nepoch 200 --approach lwm --dkd-control adaptive --dkd-m 2.0 --dkd-switch ada_switch_5 --dkd-shape one --distill-percent 0.2 --ikr-control none
