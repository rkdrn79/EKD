...
from distill_approach.distillation import Distillation
...
class Appr(Inc_Learning_Appr):
    ...
    def __init__(self, model, device, nepochs=100, lr=0.05, lr_min=1e-4, lr_factor=3, lr_patience=5, clipgrad=10000,
                 momentum=0, wd=0, multi_softmax=False, wu_nepochs=0, wu_lr_factor=1e-1, fix_bn=False, 
    ...
    def train_loop(self, t, trn_loader, val_loader, distill_approach):
        ...
        self.distill = Distillation(distill_approach, self.nepochs)
    ...
    def train_epoch(self, t, trn_loader, e):        
        ...
        for samples in trn_loader:            
            ...
            loss = self.criterion(t, outputs, target, target_r, targets_old, self.distill.loss(e))
            # Backward
    ...
    def criterion(self, t, outputs, target, kd = False, target_r=None, outputs_old=None):
        loss_KD = 0
        ...
        if t > 0 and target_r is not None:
            ...
            loss_CE_prev = self.loss(prev, target_r) #error
